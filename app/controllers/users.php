...
public function login($params=''){
    ...
    if(!empty($params)){
        ...
        if(!$data['is_registered'] || $data == NULL){ header('location:'.URL_ROOT.'/users/index/1');}
       
    }else{header('location:'.URL_ROOT.'/users/index/2');}  //no permission without correct url
