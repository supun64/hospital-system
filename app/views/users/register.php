    ...
    <form action="<?php echo URL_ROOT; ?>/users/register" method="POST" name="register-form">
        ...
        <div class="row">
            <div class="col-sm-4">
                ...
                <input type="password" class="form-control form-control-sm" id="admin-password" placeholder="Password" required minlength="8" name="admin-pwd" onkeypress="valid_input()">
            </div>
            <div class="col-sm-4">
